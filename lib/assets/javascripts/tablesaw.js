...
* MIT License
/*
 * modified locally in 2016
 * swipe-tables are now wrapped and move as many columns as possible
 * Do not replace with a new version or changes are lost
 */
...
;(function( win, $, undefined ){
	...
	function createSwipeTable( $table ){
		 ...
		 * the visible columns will be taken from the other edge. The number of visible columns always stays the same, persistant
